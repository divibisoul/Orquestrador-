...
func (m Trillium) GetPFLOPS(p core.Precision) float64 {
	return map[core.Precision]float64{core.INT8: 0.001836, core.BF16: 0.918}[p]
}
func (m Trillium) EstimateTime(wl core.Workload) time.Duration {
