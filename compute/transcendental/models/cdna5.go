...
func (m CDNA5) Supports(p core.Precision) bool { return p==core.FP4||p==core.FP8||p==core.FP16||p==core.BF16||p==core.FP32||p==core.FP64 }
func (m CDNA5) GetPFLOPS(p core.Precision) float64 { return map[core.Precision]float64{core.FP4:40,core.FP8:20,core.FP16:7.5,core.BF16:7.5,core.FP32:0,core.FP64:0}[p] }
