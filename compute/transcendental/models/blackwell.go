...
func (m BlackwellB200) Supports(p core.Precision) bool {
	switch p {
	case core.FP4, core.FP8, core.FP16, core.BF16, core.FP32, core.FP64:
		return true
	}
	return false
}
func (m BlackwellB200) GetPFLOPS(p core.Precision) float64 {
	base := map[core.Precision]float64{core.FP4: 9, core.FP8: 4.5, core.FP16: 2.25, core.BF16: 2.25, core.FP32: 0.080, core.FP64: 0.040}[p]
	if m.Sparse && base > 0 {
		return base * 2
	}
	return base
}
func (m BlackwellB200) EstimateTime(wl core.Workload) time.Duration {
	return estimateRoofline(wl, m, eff(m.Efficiency))
}
