...
func (m VeraRubin) Supports(p core.Precision) bool {
	return p == core.FP4 || p == core.FP8 || p == core.FP16 || p == core.BF16
}
func (m VeraRubin) GetPFLOPS(p core.Precision) float64 {
	return map[core.Precision]float64{core.FP4: 50, core.FP8: 25, core.FP16: 11, core.BF16: 11}[p]
}
func (m VeraRubin) EstimateTime(wl core.Workload) time.Duration {
