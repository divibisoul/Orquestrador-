...
func NewMessage(source, target, kind, operation string, payload []float64) Message {
	return Message{Version: Version, TraceID: NewTraceID(), Source: source, Target: target, Kind: kind, Operation: operation, Payload: append([]float64(nil), payload...), Metadata: map[string]string{}, Priority: 0, Sequence: uint64(time.Now().UnixNano())}
}
